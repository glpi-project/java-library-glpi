# How to contribute to GLPI API Client Library for Java
...
We present you here the guidelines to start contributing in any of the GLPI projects.
...
If you want to give us a hand solving issues then great, take a look at our [Pull Request Dashboard](https://github.com/glpi-project/java-library-glpi/pulls) and check for an open or closed PR. We don’t want to duplicate efforts.
...
## <a name="2.3"></a> 2.3 Customers Assistance
...
If you like to _implement_ a new feature please [submit an Issue](https://github.com/glpi-project/java-library-glpi/issues/new) with a proposal, so we can be sure it's relevant.

### <a name="3.1.1"></a> 3.1.1 Major Feature Request
For a major new feature request, [open an Issue](https://github.com/glpi-project/java-library-glpi/issues/new) and outline your proposal so it can be discussed.

### <a name="3.1.2"></a> 3.1.2 Minor Feature Request
For a minor new feature request, you can craft it and directly [submit it as a Pull Request](https://github.com/glpi-project/java-library-glpi/pulls), we'll take care of it.

## <a name="3.2"></a> 3.2 Request a New Feature
You can request a new feature by [submitting an Issue](https://github.com/glpi-project/java-library-glpi/issues/new).
...
Before submitting the issue please check the [Issue Tracker](https://github.com/glpi-project/java-library-glpi/issues/), maybe the issue/bug was already reported by another contributor. By doing this you help us maximize the effort spent on solving problems and the addition of new features.

### <a name="4.1.2"></a> 4.1.2 Try to Reproduce It!
Try to reproduce this issue/bug using the latest `develop` branch in the repository [Check it here](https://github.com/glpi-project/java-library-glpi/branches).
...
Having all data at hand, file the new issue by filling out our [Issue form](https://github.com/glpi-project/java-library-glpi/issues/new).
...
```git clone git@github.com:YOUR-USER-NAME/java-library-glpi.git```
...
git remote add upstream git://github.com/glpi-project/java-library-glpi.git
...
After all the work being pushed to the newly created branch, In GitHub, send a pull request to our [repository.](https://github.com/glpi-project/java-library-glpi/pulls)
...
**1 - Pull Request Description:** Write a description about the changes, we provide a [template](https://github.com/glpi-project/java-library-glpi/community) for Pull Request descriptions. When you're creating a Pull Request it'll be shown automatically. Just fill it out and you're done.

**2 - Choose the right label**: Look at the [list of available labels.](https://github.com/glpi-project/java-library-glpi/issues/labels)
